...
const StartupForm = () => {
  ...
  return (
    <form action={formAction} className="startup-form">
      <div>
        <label htmlFor="title" className="startup-from_label">
          Title
        </label>
      ...
      <div>
        <label htmlFor="description" className="startup-from_label">
          Description
        </label>
      ...
      <div>
        <label htmlFor="category" className="startup-from_label">
          Category
        </label>
      ...
      <div>
        <label htmlFor="link" className="startup-from_label">
          Link
        </label>
